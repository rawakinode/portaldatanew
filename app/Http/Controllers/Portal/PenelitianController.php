...
class PenelitianController extends Controller
{
    ...
    {
        return view('portaldata.penelitian');
    }
    ...
    public function get_data(Request $request)
    {
        ...
        $query->with(['prodi' => function ($query) {
            $query->with('penelitian');
        }]);
        $data = $query->get();

        //Membuat variabel di collection $data
        $all_data['total_penelitian'] = 0;
        ...
        foreach ($data as $d) {
            ...
            foreach ($d['prodi'] as $p) {
                ...
                //Mengolah data $data
                foreach ($p['penelitian'] as $m) {

                    $all_data['total_penelitian'] += 1;
                    $d['total_penelitian'] += 1;
                    $p['total_penelitian'] += 1;
