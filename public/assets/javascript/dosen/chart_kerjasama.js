...
function chart_bidang(label, dataset) {
    const chart_id = document.getElementById("canvas_bidang_chart");
    const bidang = new Chart(chart_id, {
        type: "bar",
        data: {
            labels: label,
            datasets: [
...
function chart_tingkat(label, dataset) {
    const chart_id = document.getElementById("canvas_tingkat_chart");
