...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Edit Audit Keuangan Eksternal</h3>
            <p class="text-subtitle text-muted">Lengkapi formulir untuk mengedit audit keuangan eksternal.</p>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Pangkalan Data</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Audit Keuangan Eksternal</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section>
        <form action="/data/universitas/audit_keuangan_eksternal/{{ $audit['id'] }}/edit" method="post">
            @csrf
                        ...
                        <div class="col-12">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('lembaga') is-invalid @enderror" type="text"
                                    name="lembaga" value="{{ old('lembaga') ?? $audit['lembaga'] }}" required>
                                @error('lembaga')
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('tahun') is-invalid @enderror" type="number"
                                    name="tahun" value="{{ old('tahun') ?? $audit['tahun'] }}" placeholder="Contoh: 2023" required>
                                @error('tahun')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('opini') is-invalid @enderror" type="text"
                                    name="opini" value="{{ old('opini') ?? $audit['opini'] }}">
                                @error('opini')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('keterangan') is-invalid @enderror" type="text"
                                    name="keterangan" value="{{ old('keterangan') ?? $audit['keterangan'] }}">
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
