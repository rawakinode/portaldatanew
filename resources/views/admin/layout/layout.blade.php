...
<head>
    ...
    <title>Dashboard | Portal Data | Universitas Tadulako</title>
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <h5 class="pt-3"><a href="/">Portaldata</a></h5>
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p>2023 &copy; LPPMP Universitas Tadulako</p>
                    </div>
                    <div class="float-end">
                        <p>Developed with <span class="text-danger"><i class="bi bi-heart"></i></span> by <a href="#">LPPMP</a></p>
                    </div>
                </div>
            </footer>
        </div>
