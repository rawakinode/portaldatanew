...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Tambah Produk & Jasa (Dosen / Mahasiswa)</h3>
            <p class="text-subtitle text-muted">Lengkapi formulir untuk menambahkan produk / jasa yang di hasilkan oleh dosen atau mahasiswa yang diadopsi oleh industri atau masyarakat.</p>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Pangkalan Data</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Tambah Produk & Jasa</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section>
        <form action="/prodi/akreditasi/produk" method="post">
            @csrf
                        ...
                        <div class="col-12">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('produk') is-invalid @enderror" type="text"
                                    name="produk" value="{{ old('produk') }}" required>
                                @error('produk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
