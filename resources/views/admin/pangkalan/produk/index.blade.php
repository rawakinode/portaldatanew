...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Produk & Jasa (Dosen / Mahasiswa)</h3>
            <p class="text-subtitle text-muted">Menampilkan daftar produk / jasa yang di hasilkan oleh dosen atau mahasiswa yang diadopsi oleh industri atau masyarakat.</p>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Pangkalan Data</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Produk & Jasa (Dosen / Mahasiswa)</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        <div class="row">
            ...
            <div class="col-sm mt-3" style="text-align: right">
                <a href="/prodi/akreditasi/produk/create"><button type="button" class="btn btn-primary"
                        style="margin-right: 15px"><i class="bi bi-plus-square"
                            style="margin-right:7px;position: relative;top: -1px;"></i> Tambah Produk & Jasa</button></a>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td width="100">
                                    <div class="d-flex text-nowrap">
                                        <a href="/prodi/akreditasi/produk/{{ $data->ids }}/edit"><button type="button"
                                                class="btn btn-sm btn-icon btn-primary" style="margin-left: 5px"><i
                                                    class="bi bi-pencil-fill"></i></button></a>
                                        <form action="/prodi/akreditasi/produk" method="post" style="margin-left: 5px">
                                            @csrf
                                            @method('delete')
                                            <input type="hidden" name="ids" id="ids" value="{{ $data->ids }}"
                                                hidden>
                                            <button type="submit" class="btn btn-sm btn-icon btn-danger"
                                                onclick="return confirm('Yakin menghapus produk ini ?')"><i
