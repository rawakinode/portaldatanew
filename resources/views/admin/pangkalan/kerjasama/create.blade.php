...
@section('content')
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            ...
            <p class="text-subtitle text-muted">Lengkapi formulir untuk menambahkan kerjasama.</p>
        </div>
    ...
    <section>
        <form action="/prodi/data/kerjasama" method="post">
            @csrf
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group mandatory">
                                ...
                                <select class="form-select @error('bidang') is-invalid @enderror" name="bidang" id="bidang" required>
                                    ...
                                    <option value="pendidikan" {{ old('bidang') == 'pendidikan' ? 'selected' : '' }}>Pendidikan
                                    </option>
                                    <option value="penelitian" {{ old('bidang') == 'penelitian' ? 'selected' : '' }}>Penelitian</option>
                                    <option value="pengabdian kepada masyarakat" {{ old('bidang') == 'pengabdian kepada masyarakat' ? 'selected' : '' }}>Pengabdian Kepada Masyarakat</option>
                                    <option value="pengembangan kelembagaan" {{ old('bidang') == 'pengembangan kelembagaan' ? 'selected' : '' }}>Pengembangan Kelembagaan</option>
                                </select>
                                @error('bidang')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
