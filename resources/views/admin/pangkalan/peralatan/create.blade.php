...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Tambah Peralatan Laboratorium</h3>
            <p class="text-subtitle text-muted">Lengkapi formulir untuk menambahkan peralatan laboratorium.</p>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Pangkalan Data</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Tambah Peralatan Laboratorium</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section>
        <form action="/prodi/akreditasi/peralatan_laboratorium" method="post">
            @csrf
                        ...
                        <div class="col-12">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('fungsi') is-invalid @enderror" type="text"
                                    name="fungsi" value="{{ old('fungsi') }}" required>
                                @error('fungsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
