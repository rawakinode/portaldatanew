...
@section('content')
    ...
    <section>
        <form action="/prodi/data/jadwalkuliah/create" method="post">
            @csrf
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('tahun') is-invalid @enderror" type="number" name="tahun"
                                    value="{{ request('tahun') ? request('tahun') : old('tahun') }}">
                                @error('tahun')
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('kode_mk') is-invalid @enderror" type="text"
                                    name="kode_mk" id="kode_mk" value="{{ old('kode_mk') }}" required>
                                @error('kode_mk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('kelas') is-invalid @enderror" type="text"
                                    name="kelas" id="kelas" value="{{ old('kelas') }}" required>
                                @error('kelas')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('ruang') is-invalid @enderror" type="text"
                                    name="ruang" id="ruang" value="{{ old('ruang') }}" required>
                                @error('ruang')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-group mandatory">
                                ...
                                <select class="form-select @error('hari') is-invalid @enderror" name="hari" id="hari">
                                    ...
                                    <option value="2" {{ old('hari') == '1' ? 'selected' : '' }}>Selasa</option>
                                    <option value="3" {{ old('hari') == '1' ? 'selected' : '' }}>Rabu</option>
                                    <option value="4" {{ old('hari') == '1' ? 'selected' : '' }}>Kamis</option>
                                    <option value="5" {{ old('hari') == '1' ? 'selected' : '' }}>Jumat</option>
                                    <option value="6" {{ old('hari') == '1' ? 'selected' : '' }}>Sabtu</option>
                                    <option value="7" {{ old('hari') == '1' ? 'selected' : '' }}>Minggu</option>
                                </select>
                                @error('hari')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <button id="hapus_btn_1" class="form-control btn btn-danger mt-2" type="button"
                                    onclick="hapusdosen('1')" style="display: none">Hapus</button>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <button class="form-control btn btn-primary mt-2" type="button"
                                    ...
                                    onclick="hapusdosen('2')" style="display: none">Hapus</button>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <button id="hapus_btn_3" class="form-control btn btn-danger mt-2" type="button"
                                    onclick="hapusdosen('3')" style="display: none">Hapus</button>
                            </div>
                        </div>
                    </div>
                </div>
