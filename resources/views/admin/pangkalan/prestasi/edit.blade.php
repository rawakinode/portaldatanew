...
@section('content')
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            ...
            <p class="text-subtitle text-muted">Lengkapi formulir untuk mengubah prestasi mahasiswa.</p>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Pangkalan Data</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Prestasi Mahasiswa</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section>
        <form action="/prodi/data/prestasi/{{ $prestasi->ids }}/edit" method="post">
            @csrf
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('nama') is-invalid @enderror" type="text" name="nama"
                                    value="{{ old('nama') ?? $prestasi['nama']}}" required>
                                @error('nama')
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('nim') is-invalid @enderror" type="text" name="nim"
                                    value="{{ old('nim') ?? $prestasi['nim']}}" required>
                                @error('nim')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group mandatory">
                                ...
                                <select class="form-select @error('bidang') is-invalid @enderror" name="bidang" id="bidang" required>
                                    ...
                                    <option value="akademik" {{ old('bidang') || $prestasi['bidang'] == 'akademik' ? 'selected' : '' }}>Akademik
                                    </option>
