...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Tambah Buku</h3>
            <p class="text-subtitle text-muted">Lengkapi formulir untuk menambahkan buku yang di hasilkan oleh dosen atau mahasiswa.</p>
        </div>
    ...
    <section>
        <form action="/prodi/akreditasi/buku" method="post">
            @csrf
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('isbn') is-invalid @enderror" type="number"
                                    name="isbn" value="{{ old('isbn') }}" placeholder="Contoh: 9786230132674" required>
                                @error('isbn')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group mandatory">
                                ...
                                <select class="form-select @error('kategori') is-invalid @enderror" name="kategori" id="kategori" required>
                                    ...
                                    <option value="buku ajar" {{ old('kategori') == 'buku ajar' ? 'selected' : '' }}>Buku Ajar</option>
                                    <option value="buku referensi" {{ old('kategori') == 'buku referensi' ? 'selected' : '' }}>Buku Referensi</option>
                                    <option value="buku monograf" {{ old('kategori') == 'buku monograf' ? 'selected' : '' }}>Buku Monograf</option>
