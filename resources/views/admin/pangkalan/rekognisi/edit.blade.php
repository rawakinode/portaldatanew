...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Edit Rekognisi Dosen</h3>
            <p class="text-subtitle text-muted">Lengkapi formulir untuk edit rekognisi.</p>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Pangkalan Data</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Rekognisi Dosen</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section>
        <form action="/prodi/akreditasi/rekognisi/{{ $rekognisi['ids'] }}/edit" method="post">
            @csrf
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('rekognisi') is-invalid @enderror" type="text"
                                    name="rekognisi" value="{{ old('rekognisi') ?? $rekognisi['rekognisi'] }}" required>
                                @error('rekognisi')
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('dosen') is-invalid @enderror" type="number"
                                    name="dosen" id="dosen" value="{{ old('dosen') ?? $rekognisi['dosen'] }}" placeholder="ketik nidn / nidk" required>
                                @error('dosen')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('tahun') is-invalid @enderror" type="number"
                                    name="tahun" value="{{ old('tahun') ?? $rekognisi['tahun'] }}" required>
                                @error('tahun')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('bidang') is-invalid @enderror" type="text"
                                    name="bidang" value="{{ old('bidang') ?? $rekognisi['bidang'] }}">
                                @error('bidang')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('keterangan') is-invalid @enderror" type="text"
                                    name="keterangan" value="{{ old('keterangan') ?? $rekognisi['keterangan'] }}">
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('bukti') is-invalid @enderror" type="text"
                                    name="bukti" value="{{ old('bukti') ??  $rekognisi['bukti']}}">
                                @error('bukti')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
