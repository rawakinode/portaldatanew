                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-group mandatory">
                                ...
                                <select class="form-select @error('kelamin') is-invalid @enderror" name="bidikmisi" id="bidikmisi" required>
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('tahun_keluar') is-invalid @enderror" type="text"
