...
@section('content')
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            ...
            <p class="text-subtitle text-muted">Lengkapi formulir untuk menambahkan mahasiswa baru</p>
        </div>
    ...
    <section>
        <form action="/prodi/data/mahasiswa" method="post">
            @csrf
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group mandatory">
                                ...
                                <select class="form-select @error('jalur_masuk') is-invalid @enderror" name="jalur_masuk" id="jalur_masuk" required>
                                    ...
                                    <option value="snmptn" {{ request('jalur_masuk') == 'snmptn' ? 'selected' : '' }}>SNMPTN
                                    </option>
                                    <option value="sbmptn" {{ request('jalur_masuk') == 'sbmptn' ? 'selected' : '' }}>SBMPTN</option>
                                    <option value="smmptn" {{ request('jalur_masuk') == 'smmptn' ? 'selected' : '' }}>SMMPTN</option>
                                    <option value="lainnya" {{ request('jalur_masuk') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                                </select>
                                @error('jalur_masuk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-12 col-md-3">
                            <div class="form-group mandatory">
                                ...
                                <select class="form-select @error('bidikmisi') is-invalid @enderror" name="bidikmisi" id="bidikmisi" required>
                                    <option value="0" {{ old('bidikmisi') == '0' ? 'selected' : '' }}>Tidak</option>
                                    <option value="1" {{ old('bidikmisi') == '1' ? 'selected' : '' }}>Ya</option>
                                </select>
                                @error('bidikmisi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('nim') is-invalid @enderror" type="text"
                                    name="nim" id="nim" value="{{ old('nim') }}" placeholder="ex : A10122001">
                                @error('nim')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="form-group mandatory">
                                ...
                                <select class="form-select @error('kelamin') is-invalid @enderror" name="kelamin" id="kelamin" required>
                                    ...
                                    <option value="0" {{ old('kelamin') == '0' ? 'selected' : '' }}>Perempuan</option>
                                </select>
                                @error('hari')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="form-group mandatory">
                                ...
                                <select class="form-select @error('asing') is-invalid @enderror" name="asing" id="asing" required>
                                    <option value="0" {{ old('asing') == '0' ? 'selected' : '' }}>Tidak</option>
                                    <option value="1" {{ old('asing') == '1' ? 'selected' : '' }}>Ya</option>
                                </select>
                                @error('asing')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('asing_part_time') is-invalid @enderror" name="asing_part_time" id="asing_part_time">
                                    <option value="">Pilih...</option>
                                    <option value="0" {{ old('asing_part_time') == '0' ? 'selected' : '' }}>Tidak</option>
                                    <option value="1" {{ old('asing_part_time') == '1' ? 'selected' : '' }}>Ya</option>
                                </select>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('tahun_keluar') is-invalid @enderror" type="number"
                                    name="tahun_keluar" id="tahun_keluar" value="{{ old('tahun_keluar') }}">
                                @error('tahun_keluar')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('kelamin') is-invalid @enderror" name="status_keluar" id="status_keluar">
                                    <option value="">Pilih...</option>
                                    <option value="lulus" {{ old('status_keluar') == 'lulus' ? 'selected' : '' }}>Lulus</option>
                                    <option value="mengundurkan diri" {{ old('status_keluar') == 'mengundurkan diri' ? 'selected' : '' }}>Mengundurkan diri</option>
                                    <option value="dropout" {{ old('status_keluar') == 'dropout' ? 'selected' : '' }}>Dropout</option>
                                    <option value="hilang" {{ old('status_keluar') == 'hilang' ? 'selected' : '' }}>Hilang</option>
                                    <option value="lainnya" {{ old('status_keluar') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                                </select>
                                @error('hari')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('ipk') is-invalid @enderror" type="text" 
                                    name="ipk" id="ipk" value="{{ old('ipk') }}" placeholder="3.35" pattern="[0-9]+([\.][0-9]+)?" title="IPK harus dalam format numerik (contoh: 3.85)">
                                @error('ipk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('masastudi') is-invalid @enderror" type="number"
                                    name="masastudi" id="masastudi" value="{{ old('masastudi') }}" placeholder="Contoh: 48" >
                                @error('masastudi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('tanggal_yudisium') is-invalid @enderror" type="date"
                                    name="tanggal_yudisium" id="tanggal_yudisium" value="{{ old('tanggal_yudisium') }}" >
