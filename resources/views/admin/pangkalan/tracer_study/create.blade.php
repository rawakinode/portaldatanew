...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Tambah Tracer Study</h3>
            <p class="text-subtitle text-muted">Lengkapi formulir untuk menambahkan tracer study.</p>
        </div>
    ...
    <section>
        <form action="/prodi/akreditasi/tracer_study" method="post">
            @csrf
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('masa_studi') is-invalid @enderror" type="number"
                                    name="masa_studi" id="masa_studi" value="{{ old('masa_studi') }}" placeholder="Contoh: 48" required>
                                @error('masa_studi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('waktu_tunggu_kerja') is-invalid @enderror" type="number"
                                    name="waktu_tunggu_kerja" id="waktu_tunggu_kerja" value="{{ old('waktu_tunggu_kerja') }}" placeholder="Contoh: 12" required>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mandatory">
                                ...
                                <select class="form-select" name="kesesuaian_bidang_ilmu" id="kesesuaian_bidang_ilmu">
                                    ...
                                    <option value="sesuai" {{ old('kesesuaian_bidang_ilmu') == 'sesuai' ? 'selected' : '' }}>Sesuai
                                    </option>
                                    <option value="kurang sesuai" {{ old('kesesuaian_bidang_ilmu') == 'kurang sesuai' ? 'selected' : '' }}>Kurang Sesuai
                                    </option>
                                    <option value="tidak sesuai" {{ old('kesesuaian_bidang_ilmu') == 'tidak sesuai' ? 'selected' : '' }}>Tidak Sesuai
                                    </option>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mandatory">
                                ...
                                <select class="form-select" name="tingkat" id="tingkat">
                                    <option value="">Pilih ...</option>
                                    <option value="lokal / wilayah / berwirausaha tidak berbadan hukum" {{ old('tingkat') == 'lokal / wilayah / berwirausaha tidak berbadan hukum' ? 'selected' : '' }}>Lokal / Wilayah / Berwirausaha Tidak Berbadan Hukum
                                    </option>
                                    <option value="nasional / berwirausaha berbadan hukum" {{ old('tingkat') == 'nasional / berwirausaha berbadan hukum' ? 'selected' : '' }}>Nasional / Berwirausaha berbadan hukum
                                    </option>
                                    <option value="multinasional / internasional" {{ old('tingkat') == 'multinasional / internasional' ? 'selected' : '' }}>Multinasional / Internasional
                                    </option>
                                    <option value="melanjutkan studi" {{ old('tingkat') == 'melanjutkan studi' ? 'selected' : '' }}>Melanjutkan Studi
                                    </option>
                                </select>
                                @error('tingkat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mandatory">
                                ...
                                <select class="form-select" name="umr" id="umr">
                                    <option value="">Pilih ...</option>
                                    <option value="1" {{ old('umr') == '1' ? 'selected' : '' }}>Diatas atau sama dengan UMR
                                    </option>
                                    <option value="0" {{ old('umr') == '0' ? 'selected' : '' }}>Dibawah UMR
                                    </option>
