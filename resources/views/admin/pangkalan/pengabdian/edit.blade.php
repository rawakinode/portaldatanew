...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            ...
            <p class="text-subtitle text-muted">Lengkapi formulir untuk edit pengabdian kepada masyarakat.</p>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Pangkalan Data</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Pengabdian</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section class="mb-3">
        <div class="row">
            <div class="col">
                ...
                <a href="/prodi/data/pengabdian" class="float-end"><button class="btn btn-primary"><i
    ...
    <section>
        <form action="/prodi/data/pengabdian/{{ $pengabdian['ids'] }}/edit" method="post">
            @csrf
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('judul') is-invalid @enderror" type="text"
                                    name="judul" value="{{ old('judul') ?? $pengabdian['judul'] }}" required>
                                @error('judul')
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('tema') is-invalid @enderror" type="text" name="tema"
                                    value="{{ old('tema') ?? $pengabdian['tema'] }}" required>
                                @error('tema')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('integrasi_pembelajaran') is-invalid @enderror" type="text" name="integrasi_pembelajaran"
                                    value="{{ old('integrasi_pembelajaran') ?? $pengabdian['integrasi_pembelajaran'] }}">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('tahun') is-invalid @enderror" type="number"
                                    name="tahun" value="{{ old('tahun') ?? $pengabdian['tahun'] }}" required>
                                @error('tahun')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mandatory">
                                ...
                                <select class="form-select @error('sumber_dana') is-invalid @enderror" name="sumber_dana"
                                    ...
                                    <option value="mandiri"
                                        {{ old('sumber_dana') || $pengabdian['sumber_dana'] == 'mandiri' ? 'selected' : '' }}>
                                        Mandiri
                                    </option>
                                    <option value="perguruan tinggi"
                                        {{ old('sumber_dana') || $pengabdian['sumber_dana'] == 'perguruan tinggi' ? 'selected' : '' }}>
                                        Perguruan Tinggi</option>
                                    <option value="nasional" {{ old('sumber_dana') || $pengabdian['sumber_dana'] == 'nasional' ? 'selected' : '' }}>
                                        Nasional</option>
                                    <option value="internasional"
                                        {{ old('sumber_dana') || $pengabdian['sumber_dana'] == 'internasional' ? 'selected' : '' }}>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('jumlah_dana') is-invalid @enderror" type="number"
                                    name="jumlah_dana" value="{{ old('jumlah_dana') ?? $pengabdian['jumlah_dana'] }}">
                                @error('jumlah_dana')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body" id="list_dosen_peneliti">
                            {{-- tempat menaruh list --}}
                            @if ($pengabdian['dosen'])
                                @foreach (json_decode($pengabdian['dosen']) as $item)
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" id="list_mahasiswa_peneliti">
                            @if ($pengabdian['mahasiswa'])
                                @foreach (json_decode($pengabdian['mahasiswa']) as $item)
