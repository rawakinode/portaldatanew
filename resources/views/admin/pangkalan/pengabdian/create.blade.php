...
<script src="https://code.jquery.com/jquery-3.5.1.js"></script>
    ...
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            ...
            <p class="text-subtitle text-muted">Lengkapi formulir untuk menambahkan pengabdian.</p>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Pangkalan Data</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Tambah Pengabdian</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section>
        <form action="/prodi/data/pengabdian" method="post">
            @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group mandatory">
                                <label for="tahun" class="form-label">Tahun Pengabdian</label>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body" id="list_dosen_pengabdi">
                            {{-- tempat menaruh list --}}
                ...
                <div class="col-12 col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body" id="list_mahasiswa_pengabdi">
    ...
    <script>
        ...
        function tambahdosen() {
            ...
            $('#list_dosen_pengabdi').append(element);
        }
        ...
        function tambahmahasiswa() {
            ...
            $('#list_mahasiswa_pengabdi').append(element);
        }
