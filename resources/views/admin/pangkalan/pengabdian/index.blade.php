...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Pengabdian</h3>
            <p class="text-subtitle text-muted">Menampilkan daftar pengabdian dosen.</p>
        </div>
    ...
    <div class="card">
        <div class="row">
            ...
            <div class="col-sm mt-3" style="text-align: right">
                <a href="/prodi/data/pengabdian/create"><button type="button" class="btn btn-primary"
                        style="margin-right: 15px"><i class="bi bi-plus-square"
                            style="margin-right:7px;position: relative;top: -1px;"></i> Tambah Pengabdian</button></a>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td width="100">
                                    <div class="d-flex text-nowrap">
                                        <a href="/prodi/data/pengabdian/{{ $pn->ids }}/edit"><button type="button"
                                                class="btn btn-sm btn-icon btn-primary" style="margin-left: 5px"><i
                                                    class="bi bi-pencil-fill"></i></button></a>
                                        <form action="/prodi/data/pengabdian" method="post" style="margin-left: 5px">
                                            @csrf
                                            @method('delete')
                                            <input type="hidden" name="ids" id="ids" value="{{ $pn->ids }}"
                                                hidden>
                                            <button type="submit" class="btn btn-sm btn-icon btn-danger"
                                                onclick="return confirm('Yakin menghapus pengabdian ini ?')"><i
