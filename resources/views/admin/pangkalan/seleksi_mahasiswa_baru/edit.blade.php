...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Edit Data Seleksi Mahasiswa Baru</h3>
            <p class="text-subtitle text-muted">Lengkapi formulir untuk edit data seleksi mahasiswa baru.</p>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Pangkalan Data</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Data Seleksi Mahasiswa Baru</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <section>
        <form action="/prodi/data/seleksi_mahasiswa_baru/{{ $seleksi_mahasiswa_baru['ids'] }}/edit" method="post">
            @csrf
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mandatory">
                                ...
                                <input class="form-control @error('tahun') is-invalid @enderror" type="number"
                                    name="tahun" value="{{ old('tahun') ?? $seleksi_mahasiswa_baru['tahun']}}" placeholder="Contoh: 2020" required>
                                @error('tahun')
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('daya_tampung') is-invalid @enderror" type="number"
                                    name="daya_tampung" value="{{ old('daya_tampung') ?? $seleksi_mahasiswa_baru['daya_tampung']}}" >
                                @error('daya_tampung')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('mahasiswa_mendaftar') is-invalid @enderror" type="number"
                                    name="mahasiswa_mendaftar" value="{{ old('mahasiswa_mendaftar') ?? $seleksi_mahasiswa_baru['mahasiswa_mendaftar']}}" >
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('mahasiswa_lulus_seleksi') is-invalid @enderror" type="number"
                                    name="mahasiswa_lulus_seleksi" value="{{ old('mahasiswa_lulus_seleksi') ?? $seleksi_mahasiswa_baru['mahasiswa_lulus_seleksi']}}" >
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('mahasiswa_baru_reguler') is-invalid @enderror" type="number"
                                    name="mahasiswa_baru_reguler" value="{{ old('mahasiswa_baru_reguler') ?? $seleksi_mahasiswa_baru['mahasiswa_baru_reguler']}}" >
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('mahasiswa_baru_transfer') is-invalid @enderror" type="number"
                                    name="mahasiswa_baru_transfer" value="{{ old('mahasiswa_baru_transfer') ?? $seleksi_mahasiswa_baru['mahasiswa_baru_transfer']}}" >
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('mahasiswa_aktif_reguler') is-invalid @enderror" type="number"
                                    name="mahasiswa_aktif_reguler" value="{{ old('mahasiswa_aktif_reguler') ?? $seleksi_mahasiswa_baru['mahasiswa_aktif_reguler']}}" >
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('mahasiswa_aktif_transfer') is-invalid @enderror" type="number"
                                    name="mahasiswa_aktif_transfer" value="{{ old('mahasiswa_aktif_transfer') ?? $seleksi_mahasiswa_baru['mahasiswa_aktif_transfer']}}" >
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('mahasiswa_aktif_luar_provinsi') is-invalid @enderror" type="number"
                                    name="mahasiswa_aktif_luar_provinsi" value="{{ old('mahasiswa_aktif_luar_provinsi') ?? $seleksi_mahasiswa_baru['mahasiswa_aktif_luar_provinsi']}}" >
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('mahasiswa_aktif_luar_negeri') is-invalid @enderror" type="number"
                                    name="mahasiswa_aktif_luar_negeri" value="{{ old('mahasiswa_aktif_luar_negeri') ?? $seleksi_mahasiswa_baru['mahasiswa_aktif_luar_negeri']}}" >
