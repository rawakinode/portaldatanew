...
@section('content')
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8 text-center">
                    ...
                    <!-- Heading -->
                    <h1 style="color:aliceblue">Mahasiswa Baru Diterima</h1>

                    <!-- Text -->
                    <p class="fs-lg mb-7 mb-md-9" style="color:aliceblue">
                        Menampilkan mahasiswa baru diterima dan yang mendaftar ulang.
                    </p>
                ...
                <form>
                    ...
                    <div class="row mt-4">
                        <div class="col-12 col-md-6 col-lg 3">
                            ...
                            <select class="form-select" aria-label="daftar ulang" name="status"
                                onchange="getDataMahasiswa();">
                                <option value="0">Diterima</option>
                                <option value="1">Mendaftar Ulang</option>
                            </select>
                        </div>
                        <div class="col-12 col-md-6 col-lg 3">
    ...
    <script src="{{ asset('assets/javascript/mahasiswa/chart_mahasiswa_baru.js') }}"></script>
