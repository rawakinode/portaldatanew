        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8 text-center">
                    ...
                    <!-- Heading -->
                    <h1 style="color:aliceblue">Data Prestasi Mahasiswa</h1>
    ...
    <section class="text-dark" style="background-color: #f2f7ff;padding-top:4rem;">
        <div class="container">
            <div class="text-center">
                ...
                <h1 style="font-weight: 600;">Tahun Prestasi</h1>
            </div>
            <div class="row mt-5">
    ...
    <script type="text/javascript">
        ...
        function prosesData(e, b) {
            ...
            for (let i = 0; i < m.length; i++) {
                ...
                label.push(fakultas);
                dataset.push(m[i].total_prestasi);
                totalstatus += m[i].total_prestasi;
            }
                ...
                for (let x = 0; x < t.length; x++) {
                    ...
                    for (let y = 0; y < r.length; y++) {
                        ...
                        var html = '<tr><td style="text-transform:capitalize">' + t[x].nama +
                            '</td><td>' + z.nim +
                            '</td><td style="text-transform:capitalize">' + z.nama + '</td><td>' + z.tahun + '</td><td style="text-transform:capitalize">' + z.bidang +
                            '</td><td style="text-transform:capitalize">'+ z.tingkat +'</td></tr>';
