@if (isset($data['penelitian_dosen_dirujuk']))
<div class="card">
    <div class="card-header">
        <h4>Tabel Penelitian Dosen yang Menjadi Rujukan Tema Tesis / Disertasi</h4>
    </div>
    <div class="card-body">
        <div class="table-responsive text-wrap">
            <table class="table" id="kerjasama" style="font-size: 0.9rem">
                ...
                <tbody class="text-center">
                    @if (isset($data['penelitian_dosen_dirujuk']))
                        @foreach ($data['penelitian_dosen_dirujuk'] as $item)
