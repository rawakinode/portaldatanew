@if (isset($data['pengabdian_dosen_mahasiswa']))
<div class="card">
    <div class="card-header">
        <h4>Tabel Pengabdian Masyarakat Dosen yang Melibatkan Mahasiswa</h4>
    </div>
    <div class="card-body">
            ...
            <table class="table" id="kerjasama" style="font-size: 0.9rem">
                <thead style="background-color: #e7ecff;color:#002f67" class="text-center">
                    <tr>
                        <th>#</th>
                        <th>Nama Dosen</th>
                        <th>Tema Pengabdian sesuai Roadmap</th>
                ...
                <tbody class="text-center">
                    @if (isset($data['pengabdian_dosen_mahasiswa']))
                        @foreach ($data['pengabdian_dosen_mahasiswa'] as $item)
