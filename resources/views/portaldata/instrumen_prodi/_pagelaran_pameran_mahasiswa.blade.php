@if (isset($data['pagelaran_pameran_mahasiswa']))
<div class="card">
    <div class="card-header">
        <h4>Tabel Pagelaran/Pameran/Presentasi/Publikasi Ilmiah Mahasiswa</h4>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table" id="data_tabel" style="font-size: 0.9rem">
                ...
                <tbody class="text-center">
                    @if (isset($data['pagelaran_pameran_mahasiswa']))
                        @foreach ($data['pagelaran_pameran_mahasiswa'] as $item)
                            @if ($loop->last)
