@if (isset($data['luaran_hki_hak_cipta_mahasiswa']))
<div class="card">
    <div class="card-header">
        <h4>Tabel HKI (Hak Cipta, Desain Produk Industri) oleh Mahasiswa</h4>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table" id="data_tabel" style="font-size: 0.9rem">
                ...
                <tbody class="text-start" style="text-transform: uppercase">
                    @if (isset($data['luaran_hki_hak_cipta_mahasiswa']))
                        @foreach ($data['luaran_hki_hak_cipta_mahasiswa'] as $item)
                            <tr>
